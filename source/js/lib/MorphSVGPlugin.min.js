    ...
    var e = Math.PI / 180,
        ...
        F = _gsScope._gsDefine.plugin({
            ...
            init: function (e, t, r, o) {
                ...
                } : "d" === a ? q(t.shapeIndex, t.map || F.defaultMap, t.precompile) : P(t.shapeIndex)), s && (this._overwriteProps.push("morphSVG"), s.end = c, s.endProp = a)), d)) : (l("WARNING: cannot morph a <" + n + "> SVG element. " + V), !1)) : (console.log("OK"))
            },
            set: function (e) {
                var t;
